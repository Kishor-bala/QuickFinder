      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-psg-gold font-semibold pt-1">
              <div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-lg border border-psg-gold/20">
                <MapPin className="w-3.5 h-3.5 text-psg-gold" />
                <span>Peelamedu, Coimbatore - 641004</span>
              </div>
              <div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-lg border border-psg-gold/20">
                <Phone className="w-3.5 h-3.5 text-psg-gold" />
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-extrabold text-psg-gold uppercase tracking-wider">Campus Navigation</h4>
            <ul className="space-y-2 text-xs sm:text-sm font-medium">
              <li>
                <Link to="/find" className="hover:text-psg-gold transition-colors">Search Lost Items</Link>
              </li>
              <li>
                <Link to="/upload" className="hover:text-psg-gold transition-colors">Upload Found Item</Link>
              </li>
              <li>
                <Link to="/report-lost" className="hover:text-psg-gold transition-colors">Report Lost Belonging</Link>
              </li>
              <li>
                <Link to="/my-items" className="hover:text-psg-gold transition-colors">My Reports & Claims</Link>
              </li>
              <li>
                <Link to="/login" className="hover:text-psg-gold transition-colors">Student / Staff Sign In</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-extrabold text-psg-gold uppercase tracking-wider">Privacy & Security</h4>
            ...
            <div className="pt-2 flex items-center gap-2 text-xs text-slate-200">
              <Shield className="w-4 h-4 text-psg-gold" />
