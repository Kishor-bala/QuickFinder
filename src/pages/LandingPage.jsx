...
export default function LandingPage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-24">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden min-h-[calc(100vh-4.5rem)] flex flex-col items-center justify-center py-6 sm:py-10">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center flex flex-col items-center space-y-4 sm:space-y-5 my-auto">
          
          {/* Institutional Header */}
          <div className="animate-fade-in-down">
            <span className="text-xs font-extrabold uppercase tracking-widest text-psg-blue bg-blue-50/80 border border-blue-200/60 px-3.5 py-1 rounded-full">
              PSG COLLEGE OF ARTS AND SCIENCE
            </span>
          </div>

          {/* Official PSG Crest Logo Image */}
          <div className="animate-fade-in-down animation-delay-100 pt-1">
            <img
              src="/psg-logo.svg"
              alt="PSG College Crest"
              className="h-16 sm:h-20 w-auto mx-auto drop-shadow-md transition-transform hover:scale-105"
            />
          </div>
          ...
          {/* Description */}
          <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium animate-fade-in-up animation-delay-100">
